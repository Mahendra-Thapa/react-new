    ...
    <div className=" m-10 ">
      <div className="grid grid-cols-2 md:grid-cols-1 ">
        <div
          style={{
            backgroundImage:
              "url('https://static8.depositphotos.com/1034557/850/i/450/depositphotos_8506681-stock-photo-sunset-yoga.jpg')",
          }}
        ...
        <div className="  text-center md:mt-8">
          <p className="flex sm:grid font-semibold gap-8 text-xl py-2">
            ...
            <input
              className="border-4 hover:border-red-300 hover:shadow-2xl"
              type="text"
              placeholder="Name"
            />
          </p>
          ...
          <p className="flex sm:grid font-semibold text-xl gap-1 py-2">
            ...
            <textarea
              className="border-4 hover:border-red-300 hover:shadow-2xl h-[120px]"
              name=""
              id=""
              cols="20"
              rows="10"
